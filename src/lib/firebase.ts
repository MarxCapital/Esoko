  ...
  try {
    ...
    if (error instanceof Error) {
      if (error.message.includes('the client is offline') || error.message.includes('unavailable')) {
        console.warn('Vérification Firebase : synchronisation hors-ligne active ou initialisation réseau en cours.');
      } else {
        console.warn('Note vérification connexion Firebase:', error.message);
      }
    }
  }
}
